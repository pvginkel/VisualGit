// VisualGit.UI\Annotate\AnnotateMarginControl.cs
//
...
namespace VisualGit.UI.Annotate
{
    sealed class AnnotateMarginControl : Control
    {
        ...
        internal void Init(IVisualGitServiceProvider context, AnnotateEditorControl control, List<AnnotateRegion> sections)
        {
            _context = context;
            _control = control;
            _regions = sections;
        ...
        private void ShowContextMenu()
        {
            ...
            if (_context != null)
            {
                ...
                cs.ShowContextMenu(VisualGitCommandMenu.AnnotateContextMenu, p.X, p.Y);
            }
        }
