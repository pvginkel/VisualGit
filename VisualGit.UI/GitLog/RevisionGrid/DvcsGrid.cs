    ...
    internal partial class DvcsGraph : DataGridView
    {
        ...
        public object[] SelectedData
        {
            get
            {
                ...
                {
                    data[i] = graphData[SelectedRows[i].Index].Node.Data;
                }
                return data;
            }
        }
        ...
        public ICollection<string> SelectedIds
        {
            get
            {
                ...
                return (
                    ...
                    where graphData[selectedRow.Index] != null
                    select graphData[selectedRow.Index].Node.Id
                ).ToArray();
            }
            set
            {
        ...
        private class Graph
        {
            ...
            public readonly Dictionary<string, Node> Nodes = new Dictionary<string, Node>(StringComparer.OrdinalIgnoreCase);
