// VisualGit.UI\VSSelectionControls\Commands\ListViewShow.cs
//
...
{
    [Command(VisualGitCommand.ListViewShow0, LastCommand = VisualGitCommand.ListViewShowMax, AlwaysAvailable = true, HideWhenDisabled = false)]
    class ListViewShow : ListViewCommandBase
    {
        protected override void OnUpdate(SmartListView list, CommandUpdateEventArgs e)
        {
            int n = (int)(e.Command - VisualGitCommand.ListViewShow0);
