...
namespace VisualGit.UI.PendingChanges.Commands
{
    ...
    /// </summary>
    [Command(VisualGitCommand.PcLogEditorOpenIssue)]
    [Command(VisualGitCommand.LogOpenIssue)]
    public class OpenIssue : ICommandHandler
    {
        ...
        bool TryGetIssue(BaseCommandEventArgs e, out IssueMarker value)
        {
            ...
            if (tv == null)
            {
                ...
                tv = ((IVisualGitHasVsTextView)editor).TextView;
            }
            ...
            if (_issueService == null)
                _issueService = e.GetService<IVisualGitIssueService>();
        ...
        public void OnUpdate(CommandUpdateEventArgs e)
        {
            switch (e.Command)
            {
                case VisualGitCommand.PcLogEditorOpenIssue:
                    {
                        IssueMarker im;
        ...
        {
            if (_issueService == null)
                _issueService = e.Context.GetService<IVisualGitIssueService>();
                ...
                case VisualGitCommand.LogOpenIssue:
                    {
                        ...
                        {
                            using (VisualGit.UI.IssueTracker.IssueSelector dlg = new VisualGit.UI.IssueTracker.IssueSelector())
                            {
