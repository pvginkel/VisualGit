...
{
    /// <summary>
    /// This is the wizard implementation for VisualGit's merge capability.
    /// </summary>
    ...
    class Handler : VisualGitService
    {
        ...
        public Handler(IVisualGitServiceProvider context, ISynchronizeInvoke synchronizer, MergeConflictHandler conflictHandler)
            : base(context)
        {
