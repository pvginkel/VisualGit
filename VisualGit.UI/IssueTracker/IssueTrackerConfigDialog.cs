...
namespace VisualGit.UI.IssueTracker
{
    ...
    public partial class IssueTrackerConfigDialog : VSDialogForm
    {
        ...
        public IssueTrackerConfigDialog(IVisualGitServiceProvider context)
        {
            InitializeComponent();
        ...
        private IssueRepositorySettings CurrentSolutionSettings
        {
            get
            {
                IVisualGitIssueService iService = Context == null ? null : Context.GetService<IVisualGitIssueService>();
