// VisualGit.Scc\VisualGitSccProvider.Enlistment.cs
//
...
namespace VisualGit.Scc
{
    ...
    partial class VisualGitSccProvider : IVsAsynchOpenFromScc
    {
        ...
        #region IVisualGitSccService Members
        ...
        void IVisualGitSccService.SerializeEnlistData(Stream store, bool writeData)
        {
            if (writeData)
