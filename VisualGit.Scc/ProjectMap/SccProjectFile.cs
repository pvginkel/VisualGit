// VisualGit.Scc\ProjectMap\SccProjectFile.cs
//
...
namespace VisualGit.Scc.ProjectMap
{
    ...
    sealed class SccProjectFile
    {
        ...
        public SccProjectFile(IVisualGitServiceProvider context, string filename)
        {
            if (context == null)
        ...
        internal void RemoveReference(SccProjectFileReference reference)
        {
            ...
            if (reference == FirstReference)
            {
                ...
                if (_firstReference == null)
                {
                    ...
                    _context.GetService<VisualGitSccProvider>().RemoveFile(this);
                }
                return;
            }
