// VisualGit.Scc\ProjectMap\SccDocumentData.cs
//
...
namespace VisualGit.Scc.ProjectMap
{
    ...
    sealed class SccDocumentData : VisualGitService, IVsFileChangeEvents, IDisposable
    {
        ...
        {
            _disposed = true;
            OpenDocumentTracker tracker = GetService<OpenDocumentTracker>(typeof(IVisualGitOpenDocumentTracker));
