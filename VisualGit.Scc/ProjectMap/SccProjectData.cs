// VisualGit.Scc\ProjectMap\SccProjectData.cs
//
...
namespace VisualGit.Scc.ProjectMap
{
    ...
    sealed partial class SccProjectData : IDisposable
    {
        ...
        public SccProjectData(IVisualGitServiceProvider context, IVsSccProject2 project)
        {
            if (context == null)
        ...
        internal void AddPath(string path)
        {
            ...
            if (!_inLoad && GetService<VisualGit.UI.IVisualGitConfigurationService>().Instance.AutoAddEnabled)
            {
        ...
        {
            get { return _scc ?? (_scc = GetService<VisualGitSccProvider>()); }
        }
