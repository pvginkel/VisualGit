// VisualGit.Scc\VisualGitSccSettingStorage.cs
//
...
namespace VisualGit.Scc
{
    ...
    sealed partial class VisualGitSccSettingStorage : VisualGitService, ISccSettingsStore, IVsSccEnlistmentPathTranslation
    {
        /// <summary>
        ...
        public VisualGitSccSettingStorage(IVisualGitServiceProvider context)
            : base(context)
        {
        }
        ...
        void EnsureLoaded()
        {
            ...
            _loaded = true;
            //GetService<IVisualGitPackage>().LoadSolutionProperties(true);
        }
