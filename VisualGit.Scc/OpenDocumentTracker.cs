// VisualGit.Scc\OpenDocumentTracker.cs
//
...
{
    [GlobalService(typeof(IVisualGitOpenDocumentTracker))]
    partial class OpenDocumentTracker : VisualGitService, IVisualGitOpenDocumentTracker, IVsRunningDocTableEvents4, IVsRunningDocTableEvents3, IVsRunningDocTableEvents2, IVsRunningDocTableEvents
    {
        ...
        public OpenDocumentTracker(IVisualGitServiceProvider context)
            : base(context)
        {
        }
        ...
        protected VisualGitSccProvider SccProvider
        {
            [DebuggerStepThrough]
        ...
        {
            [DebuggerStepThrough]
            get { return _projectTracker ?? (_projectTracker = GetService<ProjectTracker>(typeof(IVisualGitProjectDocumentTracker))); }
        }
