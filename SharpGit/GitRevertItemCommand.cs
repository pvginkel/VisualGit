// SharpGit\GitRevertItemCommand.cs
//
...
namespace SharpGit
{
    internal sealed class GitRevertItemCommand : GitCommand<GitRevertItemArgs>
    {
        public GitRevertItemCommand(GitClient client, GitClientArgs args)
            : base(client, args)
        {
        }
