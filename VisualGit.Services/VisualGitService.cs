// VisualGit.Services\VisualGitService.cs
//
...
namespace VisualGit
{
    ...
    /// </summary>
    public abstract class VisualGitService : IVisualGitServiceProvider, IComponent, IVisualGitServiceImplementation, IOleServiceProvider
    {
        readonly IVisualGitServiceProvider _context;
        /// <summary>
        /// Initializes a new instance of the <see cref="VisualGitService"/> class.
        /// </summary>
        /// <param name="context">The context.</param>
        protected VisualGitService(IVisualGitServiceProvider context)
        {
            if (context == null)
        ...
        /// Called when the service is instantiated
        /// </summary>
        void IVisualGitServiceImplementation.OnPreInitialize()
        {
            OnPreInitialize();
        }
        ...
        /// Called after all modules and services received their OnPreInitialize
        /// </summary>
        void IVisualGitServiceImplementation.OnInitialize()
        {
            OnInitialize();
        }
        ...
        /// <returns></returns>
        [DebuggerStepThrough]
        T IVisualGitServiceProvider.GetService<T>(Type type)
        {
