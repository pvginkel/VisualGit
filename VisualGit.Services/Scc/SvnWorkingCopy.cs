...
namespace VisualGit.Scc
{
    ...
    public sealed class SvnWorkingCopy : IEquatable<SvnWorkingCopy>, ISvnWcReference
    {
        ...
        SvnWorkingCopy(IVisualGitServiceProvider context, SvnItem rootItem)
        {
            if (context == null)
        ...
        internal static ISvnWcReference CalculateWorkingCopy(IVisualGitServiceProvider context, SvnItem svnItem)
        {
            if (svnItem == null)
