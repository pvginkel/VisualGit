// VisualGit.Services\Scc\UI\IVisualGitToolWindowControl.cs
//
...
{
    [CLSCompliant(false)]
    public interface IVisualGitToolWindowControl : IContextControl
    {
        IVisualGitToolWindowHost ToolWindowHost { get; set; }
        ...
        /// </summary>
        /// <param name="e">The <see cref="VisualGit.Scc.UI.FrameEventArgs"/> instance containing the event data.</param>
