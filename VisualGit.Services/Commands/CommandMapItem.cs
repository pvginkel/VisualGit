// VisualGit.Services\Commands\CommandMapItem.cs
//
...
namespace VisualGit.Commands
{
    ...
    public class CommandMapItem
    {
        ...
        /// </summary>
        /// <param name="e">The <see cref="VisualGit.Commands.CommandEventArgs"/> instance containing the event data.</param>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this command is available when VisualGit is not the active SCC
        /// </summary>
