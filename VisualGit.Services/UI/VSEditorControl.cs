// VisualGit.Services\UI\VSEditorControl.cs
//
...
namespace VisualGit.UI
{
    public class VSEditorControl : UserControl, IVSEditorControlInit, IVsWindowFrameNotify, IVsWindowFrameNotify2, IVsWindowFrameNotify3, IContextControl
    {
        ...
        IVisualGitDynamicEditorFactory _dynamicFactory;
        [CLSCompliant(false)]
        protected IVisualGitDynamicEditorFactory DynamicFactory
        {
            get { return _dynamicFactory ?? (_dynamicFactory = Context.GetService<IVisualGitDynamicEditorFactory>()); }
        }
        ...
        void IVSEditorControlInit.InitializedForm(Microsoft.VisualStudio.Shell.Interop.IVsUIHierarchy hier, uint id, IVsWindowFrame frame, IVisualGitEditorPane pane)
        {
            _frame = frame;
            _pane = pane;
    ...
    [CLSCompliant(false)]
    public interface IVisualGitEditorPane
    {
    ...
    {
        void InitializedForm(IVsUIHierarchy hier, uint id, IVsWindowFrame frame, IVisualGitEditorPane pane);
    }
