// VisualGit.Services\UI\RegistryLifoList.cs
//
...
namespace VisualGit.UI
{
    ...
    /// 
    /// </summary>
    public class RegistryLifoList : VisualGitService, ICollection<string>, IEnumerable<KeyValuePair<string, string>>
    {
        ...
        public RegistryLifoList(IVisualGitServiceProvider context, string name, int defaultSize)
            : base(context)
        {
        ...
        public RegistryLifoList(IVisualGitServiceProvider context, string name, int defaultSize, bool allowWhitespace)
        ...
        {
            get { return GetService<IVisualGitConfigurationService>(); }
        }
