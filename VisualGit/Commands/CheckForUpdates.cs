// VisualGit\Commands\CheckForUpdates.cs
//
 ...
 *   <h>VisualGit Update Available</h>
 *   <d>A new version of VisualGit 2.0 might be available.
 ...
 * i:               Update item block
 *  t:              Title of the dialog (appended to 'VisualGit -')
...
{
    [Command(VisualGitCommand.CheckForUpdates, AlwaysAvailable = true)]
    sealed class CheckForUpdates : CommandBase, IComponent
    {
        ...
        public override void OnExecute(CommandEventArgs e)
        {
            ...
            if (hwr != null)
            {
                ...
                hwr.UserAgent = string.Format("VisualGit/{0} VisualStudio/{1} Windows/{2}", version, vsVersion, osVersion);
            }
        ...
        private void OnResponse(IAsyncResult ar)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(title) && !string.IsNullOrEmpty(description))
                {
                    ...
                    cs.PostExecCommand(VisualGitCommand.CheckForUpdates,
        ...
        private IVisualGitServiceProvider Context
        {
            get { return (IVisualGitServiceProvider)_site.GetService(typeof(IVisualGitServiceProvider)); }
        }
