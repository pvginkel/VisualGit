...
{
    [Command(VisualGitCommand.FileFileOpenFromSubversion, AlwaysAvailable = true, ArgumentDefinition = "u")]
    [Command(VisualGitCommand.FileFileAddFromSubversion, AlwaysAvailable = true, ArgumentDefinition = "u")]
    [Command(VisualGitCommand.FileSccOpenFromSubversion)]
    [Command(VisualGitCommand.FileSccAddFromSubversion)]
    class OpenFromSubversion : CommandBase
    {
        public override void OnUpdate(CommandUpdateEventArgs e)
        {
            if (e.Command == VisualGitCommand.FileFileAddFromSubversion || e.Command == VisualGitCommand.FileSccAddFromSubversion)
            {
        ...
        public override void OnExecute(CommandEventArgs e)
        {
            ...
            if (e.PromptUser || selectedUri == null)
            {
                using (RepositoryOpenDialog dlg = new RepositoryOpenDialog())
                {
                    ...
                    if (e.Command != VisualGitCommand.FileFileOpenFromSubversion && e.Command != VisualGitCommand.FileSccOpenFromSubversion)
                    {
