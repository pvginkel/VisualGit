...
{
    [GlobalService(typeof(IVisualGitIssueService))]
    sealed class VisualGitIssueService : VisualGitService, IVisualGitIssueService
    {
        ...
        public VisualGitIssueService(IVisualGitServiceProvider context)
            : base(context)
        {
        }

        #region IVisualGitIssueService Members
        ...
        public void OpenIssue(string issueId)
        {
            ...
            else
            {
                ...
                {
                    IVisualGitWebBrowser web = GetService<IVisualGitWebBrowser>();
                    if (web != null)
                    {
        ...
        #region IVisualGitServiceEvents handlers
        ...
        {
            IVisualGitPackage visualGitPackage = GetService<IVisualGitPackage>();
            if (visualGitPackage != null)
            {
                using (RegistryKey key = visualGitPackage.ApplicationRegistryRoot)
                {
