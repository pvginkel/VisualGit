// VisualGit.VS\Dialogs\VSDocumentInstance.cs
//
...
{
    [ComVisible(true)]
    sealed class VSDocumentInstance : VisualGitService/*, IOleCommandTarget*/, IVsPersistDocData, IPersistFileFormat, IVsPersistDocData2, IVsPersistDocData3, IVsFindTarget, IVsFindTarget2
    {
        readonly Guid _factoryId;
        public VSDocumentInstance(IVisualGitServiceProvider context, Guid factoryId)
            : base(context)
        {
