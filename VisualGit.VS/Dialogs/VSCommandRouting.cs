// VisualGit.VS\Dialogs\VSCommandRouting.cs
//
...
{
    class VSCommandRouting : VisualGitService, IMessageFilter, IDisposable, IVsToolWindowToolbar, IOleCommandTarget
    {
        readonly VSContainerForm _form;
        readonly IVisualGitVSContainerForm _vsForm;
        ...
        public bool PreFilterMessage(ref Message m)
        {
            ...
            while (c != null)
            {
                IVisualGitPreFilterMessage filter = c as IVisualGitPreFilterMessage;
        ...
        void OnLoad(object sender, EventArgs e)
        {
            ...
            if (_form.ToolBar != 0)
            {
                System.ComponentModel.Design.CommandID tbId = new System.ComponentModel.Design.CommandID(VisualGitId.CommandSetGuid, (int)_form.ToolBar);
