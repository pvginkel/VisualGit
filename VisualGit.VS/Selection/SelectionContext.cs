// VisualGit.VS\Selection\SelectionContext.cs
//
...
namespace VisualGit.VS.Selection
{
    ...
    partial class SelectionContext : VisualGitService, IVsSelectionEvents, ISelectionContext, ISelectionContextEx, ISccProjectWalker
    {
        ...
        public SelectionContext(IVisualGitServiceProvider context)
            : base(context)
        {
        }
        ...
        protected override void OnInitialize()
        {
            ...
            _solutionExplorer = GetService<SolutionExplorerWindow>(typeof(IVisualGitSolutionExplorerWindow));
                ...
                if (_solutionFilename == null)
                {
                    if (Solution != null)
                    {
                        ...
                        if (ErrorHandler.Succeeded(Solution.GetSolutionInfo(out solutionDir, out solutionFile, out solutionUserFile)))
                        {
                            ...
                            //
                            // Follow through VisualGitIssueService#OnSolutionOpened
        ...
        IVisualGitSccService _sccService;
        IVisualGitSccService SccService
        {
            [DebuggerStepThrough]
            get { return _sccService ?? (_sccService = GetService<IVisualGitSccService>()); }
        }
