// VisualGit.VS\Selection\SelectionUtils.cs
//
...
namespace VisualGit.VS.Selection
{
    static class SelectionUtils
    {
        ...
        //[CLSCompliant(false)]
        public static IVsSccProject2 GetSolutionAsSccProject(IVisualGitServiceProvider context)
        {
            if (context == null)
                throw new ArgumentNullException("context");
        ...
        class SolutionSccHelper : IVsSccProject2
        {
            ...
            public SolutionSccHelper(IVisualGitServiceProvider context)
            {
                _context = context;
            }
