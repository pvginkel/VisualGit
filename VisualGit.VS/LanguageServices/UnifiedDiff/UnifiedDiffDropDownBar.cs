// VisualGit.VS\LanguageServices\UnifiedDiff\UnifiedDiffDropDownBar.cs
//
...
{
    class UnifiedDiffDropDownBar : VisualGitLanguageDropDownBar, IVsTextLinesEvents
    {
        ...
        bool _shouldParse;
        protected override void OnIdle(VisualGitIdleArgs e)
        {
            base.OnIdle(e);
