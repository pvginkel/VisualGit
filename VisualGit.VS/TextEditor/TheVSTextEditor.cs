// VisualGit.VS\TextEditor\TheVSTextEditor.cs
//
...
namespace VisualGit.UI.VS.TextEditor
{
    /// <summary>
    /// This class is used to implement CodeEditorUserControl
    /// </summary>
    /// <seealso cref="UserControl"/>
    partial class TheVSTextEditor : Control, IVisualGitPreFilterMessage, IVisualGitHasVsTextView, IVSTextEditorImplementation
    {
        ...
        void InitializeForm(VSContainerForm ownerForm)
        {
            ...
            IVisualGitVSContainerForm cf = ownerForm;
        ...
        bool _inToolWindow;
        void InitializeToolWindow(IVisualGitToolWindowControl toolWindow)
        {
            _inToolWindow = true;
    ...
    /// </summary>
    internal class CodeEditorWindow : VisualGitService, IOleCommandTarget, IDisposable, IVsTextViewEvents
    {
        #region Fields
