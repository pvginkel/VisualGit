// VisualGit.VS\SolutionExplorer\SolutionExplorerWindow.cs
//
...
namespace VisualGit.VS.SolutionExplorer
{
    ...
    /// 
    /// </summary>
    [GlobalService(typeof(IVisualGitSolutionExplorerWindow))]
    sealed class SolutionExplorerWindow : VisualGitService, IVsWindowFrameNotify, IVsWindowFrameNotify2, IDisposable, IVisualGitSolutionExplorerWindow
    {
        ...
        #region IVisualGitSolutionExplorerToolWindow Members


        public void EnableVisualGitIcons(bool enabled)
        {
            _manager.Ensure(this);

            _manager.SetVisualGitIcons(enabled);
        }
