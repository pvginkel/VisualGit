// VisualGit.VS\WebBrowser\VisualGitWebBrowser.cs
//
...
namespace VisualGit.VS.WebBrowser
{
    [GlobalService(typeof(IVisualGitWebBrowser))]
    class VisualGitWebBrowser : VisualGitService, IVisualGitWebBrowser
    {
        public VisualGitWebBrowser(IVisualGitServiceProvider context)
            : base(context)
        {
        }
        ...
        {
            VisualGitBrowserResults results;
            Navigate(url, new VisualGitBrowserArgs(), out results);
        }

        public void Navigate(Uri url, VisualGitBrowserArgs args)
        {
            VisualGitBrowserResults results;
            Navigate(url, args, out results);
        }

        public void Navigate(Uri url, VisualGitBrowserArgs args, out VisualGitBrowserResults results)
        {
        ...
        private class Results : VisualGitBrowserResults
        {
