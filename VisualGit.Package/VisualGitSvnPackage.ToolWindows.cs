...
namespace VisualGit.VSPackage
{
    ...
    [ProvideToolWindowVisibility(typeof(SvnInfoToolWindow), VisualGitId.SccProviderId)]
    public partial class VisualGitSvnPackage
    {
        ...
        Type GetPaneType(VisualGitToolWindow toolWindow)
        {
            switch (toolWindow)
            {
                ...
                case VisualGitToolWindow.SvnInfo:
    ...
    [Guid(VisualGitId.SvnInfoToolWindowId)]
    class SvnInfoToolWindow : VisualGitToolWindowPane
    {
        public SvnInfoToolWindow()
        {
            ...
            VisualGitToolWindow = VisualGitToolWindow.SvnInfo;

            ToolBar = new CommandID(VisualGitId.CommandSetGuid, (int)VisualGitToolBar.SvnInfo);
            ToolBarLocation = (int)VSTWT_LOCATION.VSTWT_TOP;
        }
    }
}
