// VisualGit.Package\VisualGitPackage.SolutionProperties.cs
//
...
namespace VisualGit.VSPackage
{
    ...
    partial class VisualGitPackage : IVsPersistSolutionProps
    {
        ...
        public int SaveSolutionProps(IVsHierarchy pHierarchy, IVsSolutionPersistence pPersistence)
        {
            ...
            if (pHierarchy == null) // Only save the property on the solution itself
            {
                ...
                if (scc != null && scc.HasSolutionData)
                    pPersistence.SavePackageSolutionProps(1 /* TRUE */, null, this, GitPropertyCategory);
        ...
        const string SccPendingChangeStream = VisualGitId.GitSccName + "Pending";
        const string SccEnlistStream = VisualGitId.GitSccName + "Enlist";
        ...
        public int ReadUserOptions([In] IStream pOptionsStream, [In] string pszKey)
        {
            try
            {
                ...
                return VSConstants.S_OK; // Our data is in Git properties
            }
            finally
            {
