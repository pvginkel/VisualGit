...
namespace VisualGit.VSPackage
{
    ...
    [ProvideService(typeof(ITheVisualGitSvnSccProvider), ServiceName = VisualGitId.SubversionSccName)]
    ...
    sealed partial class VisualGitSvnPackage : Package, IVisualGitPackage, IVisualGitQueryService
    {
