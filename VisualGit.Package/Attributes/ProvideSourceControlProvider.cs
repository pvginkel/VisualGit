// VisualGit.Package\Attributes\ProvideSourceControlProvider.cs
//
...
namespace VisualGit.VSPackage.Attributes
{
    ...
    internal sealed class ProvideSourceControlProviderAttribute : RegistrationAttribute
    {
        ...
        public Guid RegGuid
        {
            get { return VisualGitId.SccProviderGuid; }
        }
        ...
        {
            get { return typeof(VisualGit.Scc.ITheVisualGitSccProvider).GUID; }
        }
        ...
        public override void Register(RegistrationContext context)
        {
            ...
            context.Log.WriteLine(String.Format(CultureInfo.CurrentCulture,
                "VisualGit Source Control Provider:\t\t{0}\n", RegName));
        ...
        {
            context.RemoveKey("SourceControlProviders\\" + VisualGitId.SccProviderGuid.ToString("B"));
        }
    }
}
